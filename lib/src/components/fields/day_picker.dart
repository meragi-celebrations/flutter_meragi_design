...
enum MDDatePickerVariant { single, range }

class MDDayPicker extends StatefulWidget {
  const MDDayPicker({
    super.key,
    this.placeholder,
    ...
    this.onFocusChange,
    this.iconSrc,
  })  : variant = MDDatePickerVariant.single,
        formatDateRange = null,
        selectedRange = null;

  const MDDayPicker.range({
    super.key,
    this.popoverController,
    this.placeholder,
    ...
    this.onFocusChange,
    this.iconSrc,
  })  : variant = MDDatePickerVariant.range,
        selected = null,
        formatDate = null,
        selectedRange = selected;

  const MDDayPicker.raw({
    super.key,
  ...
  /// {@endtemplate}
  final MDPopoverController? popoverController;
  ...
  /// {@endtemplate}
  final MDDatePickerVariant variant;
  ...
  @override
  State<MDDayPicker> createState() => _MDDayPickerState();
}

class _MDDayPickerState extends State<MDDayPicker> {
  late DateTime? selected = widget.selected;
  late ShadDateTimeRange? selectedRange = widget.selectedRange;

  MDPopoverController? _popoverController;

  MDPopoverController get popoverController =>
  ...
  void initState() {
    ...
    if (widget.popoverController == null) {
      _popoverController = MDPopoverController();
    }
  }

  @override
  void didUpdateWidget(covariant MDDayPicker oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final isSelected = switch (widget.variant) {
      MDDatePickerVariant.single => selected != null,
      MDDatePickerVariant.range =>
          ...
          children: [
            ...
            ShadCalendar.raw(
              variant: switch (widget.variant) {
                MDDatePickerVariant.single => ShadCalendarVariant.single,
                MDDatePickerVariant.range => ShadCalendarVariant.range,
              },
              selected: selected,
