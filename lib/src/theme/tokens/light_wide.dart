...
ThemeToken lightWide = ThemeToken(
  ...
  smButtonHeight: 25,
  smButtonPadding: const EdgeInsets.symmetric(horizontal: 9),
  rgButtonHeight: 32,
  rgButtonPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: 0),
  lgButtonHeight: 38,
  lgButtonPadding: const EdgeInsets.symmetric(horizontal: 20, vertical: 0),
  smBorderRadius: 4,
  rgBorderRadius: 6,
  lgBorderRadius: 8,
  smButtonIconSize: 11,
